...
export default function Footer() {
  return (
    <footer className="bg-espresso text-latte mt-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 grid grid-cols-2 md:grid-cols-4 gap-10">
        <div>
          ...
          <p className="mt-3 text-latte/80 text-sm max-w-xs">
            From soil to soul. Specialty coffee from partners around the world,
            roasted and brewed in Fitzroy.
          </p>
          <p className="mt-3 text-latte/70 text-sm">213 Gertrude St, Fitzroy</p>
        </div>
        <div>
          <h4 className="font-semibold">Shop</h4>
          <ul className="mt-3 space-y-2 text-sm text-latte/80">
      ...
      <div className="border-t border-latte/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-latte/70 text-sm">© {new Date().getFullYear()} Bitter & Bloom</p>
          <div className="flex items-center gap-6 text-sm text-latte/80">
